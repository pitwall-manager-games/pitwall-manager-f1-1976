...
* **Cansancio:** Aumenta en las mismas situaciones que el estrés. No se recupera durante la carrera. Afecta al rendimiento del piloto.

### 4.3. Ventana de Pit Stop
* El jugador puede activar el checkbox "Solicitar parada" en cualquier momento de la vuelta.
* La orden de parada se ejecuta al completar la vuelta actual, momento en el que el piloto recibe el cartel indicando la entrada a boxes.
