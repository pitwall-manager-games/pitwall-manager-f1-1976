...
- La orden de parada se ejecuta al completar la vuelta actual, momento en el que
  el piloto recibe el cartel indicando la entrada a boxes
- El coche entra al Pit Lane automáticamente al completar la vuelta si la parada
  está solicitada
